...
OWNER_ID = int(getenv("OWNER_ID", 6674736826))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/DAKSHXMUSIC/BrandrdXMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/study_with_brandl")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/HMlOGRl")
